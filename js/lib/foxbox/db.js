define(['exports', './common/defer'], function (exports, _defer) {
  'use strict';
  ...
  class Db {
    ...
    init() {
      ...
      return initializationPromise.catch(error => {
    ...
    clear() {
      return this[p.db].promise.then(db => {
        db.close();
