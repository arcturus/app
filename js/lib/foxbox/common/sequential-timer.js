define(['exports'], function (exports) {
  ...
  class SequentialTimer {
    ...
    [p.scheduleTick]() {
      ...
      this[p.nextTickHandle] = setTimeout(() => {
        ...
        new Promise(resolve => resolve(this[p.onTick]())).catch(error => {
          console.error('onTick handler failed, scheduling next tick anyway: %o', error);
        }).then(() => {
          this[p.nextTickHandle] = null;
          this[p.scheduleTick]();
        });
  ...
  exports.default = SequentialTimer;
});