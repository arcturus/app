define(['exports', './common/event-dispatcher'], function (exports, _eventDispatcher) {
  ...
  class WebPush extends _eventDispatcher2.default {
    ...
    subscribeToNotifications(resubscribe = false) {
      ...
      navigator.serviceWorker.addEventListener('message', this[p.listenForMessages].bind(this));
      ...
      return navigator.serviceWorker.ready.then(reg => {
        reg.pushManager.subscribe({ userVisibleOnly: true }).then(subscription => {
          ...
          return this[p.api].put('channels/set', pushConfigurationMsg).then(() => {
