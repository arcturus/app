define(['exports', '../common/event-dispatcher'], function (exports, _eventDispatcher) {
  ...
  class BaseService extends _eventDispatcher2.default {
    constructor(props, api, allowedEvents) {
      ...
      this[p.name] = props.properties && props.properties.name || props.properties.product_name || '';
    ...
    set(selector, value = '') {
      ...
      return this[p.api].put('channels/set', [[{ id: setter.id }, { [setterType]: value }]]);
    }
    ...
    get(selector) {
      ...
      return this[p.api].put('channels/get', body).then(response => response[getter.id]);
    }
